// server.js (Updated with correct static path)
...
// ✅✅✅ FIXED LINE - Changed from 'frontend' to '../frontend' ✅✅✅
  ...
  try {
    ...
    if (username === 'admin') {
      ...
      if (!user) {
        ...
        user = new User({ username: 'admin', password: hash });
        await user.save();
      }
    } else {
...
const OFFICE_LAT = 11.274368;
const OFFICE_LON = 77.607518;
